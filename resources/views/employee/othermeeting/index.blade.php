...
<div class="container-fluid p-0">
    ...
    <h1 class="h3 mb-3">{{__('text.meeting')}}  - {{__('text.other_department')}} </h1>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table id="myTable" class="table display" >
                        ...
                        <tbody>
                            @foreach ($meeting_other as $item)
                                <tr>
                                    {{-- <td>{{$item->id}}</td> --}}
                                    <td>A-{{$item->meeting->id}}</td>
                                    <td>{{$item->meeting->subject}}</td>
                                    <td>{{$item->meeting->participants->count()}}</td>
                                    <td>{{$item->meeting->department->name}}</td>
                                    ...
                                    <td class="table-action">
                                        ...
                                        <a href="{{URL::to('/employee-other-meeting/'.$item->meeting->id)}}"><i class="align-middle" data-feather="eye"></i></a>
