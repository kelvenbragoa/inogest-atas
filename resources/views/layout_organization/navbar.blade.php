            ...
            <ul class="navbar-nav navbar-align">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right py-0" aria-labelledby="alertsDropdown">
                        <div class="dropdown-menu-header">
                            <a href="{{route('notification.index')}}" class="text-muted">{{count(Auth::user()->unreadNotifications)}} {{__('text.notification')}}</a>
                        </div>
                        <div class="list-group">
                            @foreach (Auth::user()->unreadNotifications as $item)
                            <a href="{{route('notification.index')}}" class="list-group-item">
                                <div class="row g-0 align-items-center">
                                    <div class="col-2">
                        ...
                        <div class="dropdown-menu-footer">
                            <a href="{{route('notification.index')}}" class="text-muted">{{__('text.show_notification')}}</a> <br>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="{{route('configuration.index')}}"><i class="align-middle mr-1" data-feather="settings"></i>{{__('text.config')}}</a>
