        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                     <a href="{{route('manager-employee.create')}}" class="btn btn-pill btn-primary"><i class="far fa-plus"></i>{{__('text.add')}}</a> 
                            ...
                            @foreach ($employee as $item)
                                <tr>
                                    ...
                                    <td class="table-action">
                                        ...
                                        <a href="{{URL::to('/manager-employee/'.$item->id)}}"><i class="align-middle" data-feather="eye"></i></a>
