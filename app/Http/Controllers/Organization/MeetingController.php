...
class MeetingController extends Controller
{
    ...
    public function index()
    {
        ...
        $meetings = Meeting::orderBy('id','desc')->where('organization_id',Auth::user()->organization_id)->get();
        return view('organization.meeting.index',compact('meetings'));
    }
    ...
    public function create()
    {
        //
        App::setLocale(auth()->user()->lang);
        return view('organization.meeting.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('organization-meeting.index')->with('messageSuccess', 'Acta da Reunião criada com sucesso');
    }
    ...
    public function show($id)
    {
        ...
        return view('organization.meeting.show',compact('meeting','participants','departments'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('organization-meeting.index')->with('messageSuccess', 'Acta da Reunião editada com sucesso');
    }
    ...
    public function download($id)
    {
        App::setLocale(auth()->user()->lang);
        $meeting = Meeting::find($id);
        $pdf = Pdf::loadView('organization.meeting.meeting', compact('meeting'))->setOptions([
