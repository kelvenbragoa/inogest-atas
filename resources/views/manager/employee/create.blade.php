        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" id="form" action="{{route('manager-employee.store')}}">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" name="email" id="source" placeholder="Email" value="{{ old('email') }}" required>
                            </div>
