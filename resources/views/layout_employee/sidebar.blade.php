<nav id="sidebar" class="sidebar" >
    <div class="sidebar-content js-simplebar">
        ...
        <ul class="sidebar-nav">
            ...
            {{-- <li class="sidebar-item">
                <a class="sidebar-link" href="{{route('employee-meeting.index')}}">
                <i class="align-middle" data-feather="file"></i> <span class="align-middle">Reunião</span>
                </a>
            </li> --}}

            <li class="sidebar-item">
                <a href="#dashboard3" data-toggle="collapse" class="sidebar-link collapsed">
                <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">{{__('text.meeting')}}</span>
                </a>
                <ul id="dashboard3" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                    <li class="sidebar-item"><a class="sidebar-link" href="{{route('employee-meeting.index')}}">{{__('text.department')}}</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="{{route('employee-other-meeting.index')}}">{{__('text.other_department')}}</a></li>
                </ul>
            </li>

            <li class="sidebar-item">
                <a class="sidebar-link" href="{{route('employee-meetingtask.index')}}">
                <i class="align-middle" data-feather="target"></i> <span class="align-middle">{{__('text.tasks')}}</span>
                </a>
            </li>
            ...
            <li class="sidebar-item">
                <a class="sidebar-link" href="{{route('employee-configuration.index')}}">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link" href="{{route('employee-tickets.index')}}">
