                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">{{__('text.tickets')}}</h5>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                         ...
                                         <div class="col-sm-4">
                                            <div class="card">
                                                <div class="card-body">
                                                    <h5 class="card-title mb-4">{{__('text.sales')}}</h5>
                                                    <div class="row">
                                                        <div class="col">
                                                            <p class="mt-1 mb-3">{{__('message.sales_message')}}</p>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="card">
                                                <div class="card-body">
                                                    <h5 class="card-title mb-4">{{__('text.payment')}}</h5>
                                                    <div class="row">
                                                        <div class="col">
                                                            <p class="mt-1 mb-3">{{__('message.payment_message')}}</p>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="{{route('tickets.create')}}" class="btn btn-primary">{{__('text.add')}}</a>
                    ...
                    <table id="myTable" class="table display" >
                        <thead>
                            <tr>
                                ...
                                <th style="width:30%">{{__('text.tickets')}}</th>
                            ...
                            @foreach ($tickets as $item)
                                <tr>
                                    ...
                                    <td class="table-action">
                                        ...
                                        <a href="{{URL::to('/tickets/'.$item->id)}}"><i class="align-middle" data-feather="eye"></i></a>
                                        {{-- <a href="" data-toggle="modal" data-target="#exampleModalCenter{{$item->id}}"><i class="align-middle" data-feather="trash"></i></a> --}}
                                    </td> 
                                </tr>
                                @include('organization.tickets.modaldelete')
                            @endforeach
                        </tbody>
                    </table>
                    </div>
