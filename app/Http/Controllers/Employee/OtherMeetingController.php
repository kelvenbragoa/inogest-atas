...
class OtherMeetingController extends Controller
{
    ...
    public function index()
    {
        ...
        $meeting_other = MeetingParticipant::where('user_id',Auth::user()->id)->where('source',1)->get();

   

       
        return view('employee.othermeeting.index',compact('meeting_other'));
    ...
    {
        //
        return view('employee.othermeeting.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('employee-other-meeting.index')->with('messageSuccess', 'Acta da Reunião criada com sucesso');
    }
    ...
    public function show($id)
    {
        ...
        return view('employee.othermeeting.show',compact('meeting','participants','departments','meeting_participant_id','days'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('employee-other-meeting.index')->with('messageSuccess', 'Acta da Reunião editada com sucesso');
    }
    ...
    {
        $meeting = Meeting::find($id);
        $pdf = Pdf::loadView('employee.othermeeting.meeting', compact('meeting'))->setOptions([
