                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form>
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="inputAddress2">{{__('text.organization')}}</label>
                                    <input type="text" class="form-control" id="inputAddress2" value="{{Auth::user()->organization->name ?? ''}}"  readonly>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="inputAddress2">{{__('text.department')}}</label>
                                    <input type="text" class="form-control" id="inputAddress2" value="{{Auth::user()->department->name ?? ''}}"  readonly>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{URL::to('/employee-changepassword')}}">
                                @csrf
                                <div class="mb-3">
